...
class __TwigTemplate_ad7730b5f9bd457871dae63154e5d597da6b39e6a3667835d10a3bda9ced2e2a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('cours_delete', {'id': cour.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ cour.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "cours/_delete_form.html.twig", "C:\\xampp\\htdocs\\complexeSportif\\templates\\cours\\_delete_form.html.twig");
    }
}
