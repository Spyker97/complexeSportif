...
<style>
    * {
    ...
    body {
        min-height: 100%;
        background-image : url (\"https://ibb.co/pytFBzg\");
    ...
    .login-root {
        background-image: image-set(\"C:\\Users\\Skander\\Downloads\\interieur-salle-sport-equipements_23-2147949749.jpg\");
        display: flex;
        width: 100%;
        min-height: 100vh;
        overflow: hidden;
    ...
    .box-divider--light-all-2 {
        box-shadow: inset 0 0 0 2px #d5d811;
    }
    .box-background--blue {
    ...
    .field input {
        ...
        border: unset;
        border-radius: 4px;
        outline-color: rgba(116, 117, 122, 0.5);
...
<div class=\"login-root\">
    ...
    <div class=\"box-root padding-top--24 flex-flex flex-direction--column\" style=\"flex-grow: 1; z-index: 9;\">
        <div class=\"box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center\">
            <h1><a href=\"http://blog.stackfindover.com/\" rel=\"dofollow\">EXTRA SPORT</a></h1>
        </div>
    ...
    {
        return array (  398 => 313,  373 => 290,  363 => 289,  336 => 321,  334 => 289,  44 => 1,);
    }
...
</html>", "base.login.html.twig", "C:\\xampp\\htdocs\\complexeSportif\\templates\\base.login.html.twig");
    }
}
